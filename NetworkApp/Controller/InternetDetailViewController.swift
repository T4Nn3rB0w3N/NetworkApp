...
//  NetworkApp
//
//  Created by Bowen, Tanner on 12/14/18.
...
public class InternetDetailViewController: UIViewController
{
    ...
    {
        if let contentPDF = Bundle.main.url(forResource: "Internet Screen topics assignment", withExtension: "pdf", subdirectory: nil, localization: nil)
        {
